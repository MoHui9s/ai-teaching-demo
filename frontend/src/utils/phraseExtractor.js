...
/**
 * 按块级元素处理：逐短语包裹，每次包裹后重新收集文本节点以保证位置正确
 */
...
function wrapPhraseInNodes(textNodes, phrase) {
  ...
  // 收集从 first.node 到 last.node 的所有同胞节点
  const nodesToWrap = []
